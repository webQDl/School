    ...
    <div class="sq_sp_content">
      <div class="jx_top_bc_title">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>资产存放地点设置</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="jx_top_bc_content">
        <div style="font-size:16px;margin-bottom:20px">存放地点列表</div>
        <div>
          <el-button type="danger" @click="clickAddBtn()"><i class="el-icon-plus"></i>新增地点</el-button>
        ...
        <div style="font-size:16px;margin-top:20px">
          <el-table id="roleTable" :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border style="width: 100%" :header-cell-style="{background:'#909399',color:'#333'}">>
            <el-table-column prop="role_id" label="序号" width="150" align="center"></el-table-column>
            <el-table-column prop="role_name" label="存放地点" width="360" align="center"></el-table-column>
            <el-table-column prop="role_sId" label="地点编号" width="360" align="center">
              <template slot-scope="scope">
                <span v-text="['管理员', '管理员','城市经理','城市经理','学校经理','老师'][scope.row.role_sId]"></span>
              </template>
            </el-table-column>
