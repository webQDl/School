  ...
  <div class="zc_jx_rk">
    ...
    <div class="sq_sp_content">
      ...
      <div class="jx_top_bc_content">
        <div style="font-size:16px;margin-bottom:20px">入库记录</div>
      <div>
          <el-button type="danger" @click="clickAddBtn()"><i class="el-icon-plus"></i>添加设备</el-button>
          <el-input placeholder="请输入编码或名称" v-model="input_rkName" class="el-inp-m" style="margin-left:20px"></el-input>
          <div class="demo-input-suffix" style="margin-left:50px">入库时间：
          ...
          <div style="float:right">
            <el-button type="warning">批量引进</el-button>
        ...
        <div style="font-size:16px;margin-top:20px">
          <el-table id="roleTable" :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border style="width: 100%" :header-cell-style="{background:'#909399',color:'#333'}">>
            ...
            <el-table-column prop="zc_type" label="分类" width="200" align="center"></el-table-column>
            <el-table-column prop="zc_name" label="名称" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_code" label="编码" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_price" label="单价（元）" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_num" label="数量" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_gmType" label="规格" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_address" label="存放地点" width="130" align="center"></el-table-column>
            <el-table-column prop="zc_pri" label="是否唯一" width="100" align="center">
              <template slot-scope="scope">
                <span v-html="['是', '否'][scope.row.zc_pri]"></span>
              </template>
            </el-table-column>
            <el-table-column prop="zc_date" label="入库时间" width="100" align="center"></el-table-column>
            <el-table-column prop="zc_state" label="上报状态" width="100" align="center">
              <template slot-scope="scope">
                <span v-html="[zc_state_success, '未上报'][scope.row.zc_state]"></span>
              </template>
            </el-table-column>
            <el-table-column fixed="right" label="操作" width="180" align="center">
              <template slot-scope="scope" v-if="scope.row.zc_type!=null">
                <span size="small" style="margin:0 20px;cursor: pointer;" @click="clickUpdBtn(scope.$index,scope.row)">编辑</span>
                <span size="small" style="margin:0 20px;cursor: pointer;" @click="handleDelete(scope.$index)">删除</span>
              </template>
            </el-table-column>
          </el-table>
  ...
  data() {
      return {
        ...
        tableData: [{
          ...
          zc_date: '2017-11-6',
          zc_state: '0',
        },{zc_state: '0'},{zc_state: '1'},{zc_state: '1'},{},{},{},{},{},{},{},{}]
      }
    }
}
</script>
